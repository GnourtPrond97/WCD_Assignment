                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" action="/item/edit" method="post" id="edit-item">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="itemId"
                                                           value="<%=editItem.getItemId()%>" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="itemName"
                                                           value="<%=editItem.getItemName()%>" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="categoryId" id="categoryId" class="form-control">
                                                        ...
                                                        %>
                                                        <li>
                                                            <option selected=<%=editItem.getCategoryId()== listCate.get(i).getId()  ? "selected" : null %> value=<%= listCate.get(i).getId()%>><%= listCate.get(i).getName()%>
                                                            </option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9 ">
                                                    <input type="text" class="form-control" name="price"
                                                           value="<%=editItem.getPrice()%>" required/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9 cover">
                                                    <%
                                                        if (editItem.getAvatar() != null) {
                                                    %>
                                                    <img src="<%=editItem.getImage()%>" width="400" height="300"/>
                                                    <%
                                                        }
                                                    %>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea type="text" class="form-control"
                                                              name="description" ><%=editItem.getDescription()%></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
